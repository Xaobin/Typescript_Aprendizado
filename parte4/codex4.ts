/*
 * Símbolos (Symbols)
 * https://www.typescriptlang.org/pt/docs/handbook/symbols.html
...
Em adição aos símbolos definidos pelo usuário, existem símbolos internos, bem conhecidos. Símbolos internos são usados para representar comportamentos internos das linguagem.
...
Symbol.search
Um método de expressão regular que retorna o índice dentro de uma string que condiz com a expressão regular. Chamado pelo métodoString.prototype.search.
